...
fetch("http://localhost:3000/note")
    ...
    .then(function (notes) {
      ...
      <div >
         <div class="note" style="background-color:${note.color}">
                ...
                <span class="material-icons-outlined hover small-icon" style="float:right" onclick="UnPin(${note.id})">push_pin</span>
    ...
    function UnPin(id){
        ...
        body: JSON.stringify(
        {
            "pin": "false"          // we are changing the "likes" value to 5
        }
      )
    });
    }